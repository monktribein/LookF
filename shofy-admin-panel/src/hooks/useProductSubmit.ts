...
const useProductSubmit = () => {
  ...
  const handleSubmitProduct = async (data: any) => {
    ...
    const productData = {
      ...
      subCategorySlug: subCategorySlug || slugify(children || "", { lower: true }),
      ...
      category: category,
      categoryName,
      categorySlug: categorySlug || slugify(categoryName || "", { lower: true }),
      status: status,
      offerDate: {
    ...
    if (!subCategory) {
      return notifyError("Sub-category is required");
    }
