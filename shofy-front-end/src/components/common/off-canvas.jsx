...
const OffCanvas = ({ isOffCanvasOpen, setIsCanvasOpen,categoryType = "men" }) => {
          ...
          <div className="offcanvas__bottom">
            <div className="offcanvas__footer d-flex align-items-center justify-content-between">
              <div className="offcanvas__currency-wrapper currency">
                <span onClick={handleCurrencyActive} className="offcanvas__currency-selected-currency tp-currency-toggle" id="tp-offcanvas-currency-toggle">Currency : {selectedCurrency}</span>
                <ul className={`offcanvas__currency-list tp-currency-list ${isCurrencyActive ? 'tp-currency-list-open' : ''}`}>
                   <li><button type="button" className="cursor-pointer" onClick={() => handleCurrencySelect("INR")}>INR</button></li>
                  <li><button type="button" className="cursor-pointer" onClick={() => handleCurrencySelect("USD")}>USD</button></li>
                  <li><button type="button" className="cursor-pointer" onClick={() => handleCurrencySelect("ERU")}>ERU</button></li>
                  <li><button type="button" className="cursor-pointer" onClick={() => handleCurrencySelect("BDT")}>BDT</button></li>
                  <li><button type="button" className="cursor-pointer" onClick={() => handleCurrencySelect("CHF")}>CHF</button></li>
                </ul>
              </div>
