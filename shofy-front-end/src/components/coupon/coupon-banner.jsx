    ...
    <>
      ...
      <section className="tp-coupon-banner-area py-4 bg-white">
        <div className="container">
          ...
          {/* Static Coupons Container (responsive grid) */}
          <div className="row g-4 justify-content-center">
            {coupons.map((coupon) => (
              <div key={coupon.id} className="col-12 col-sm-6 col-lg-3 d-flex justify-content-center">
                <div className="bg-gray-400 text-white p-3 rounded shadow-lg border border-light-pink coupon-card position-relative w-100" style={{ minWidth: '260px' }}>
                  {/* Left Logo Section */}
